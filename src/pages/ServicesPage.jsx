...
const ServicesPage = () => {
  ...
  const TitleCards = "text-xl font-bold text-primary";
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute w-[22rem] h-[22rem] bg-primary/10 blur-3xl top-0 -right-10 pointer-events-none" />
      <div className="absolute w-[22rem] h-[22rem] bg-accent/10 blur-3xl bottom-0 -left-10 pointer-events-none" />

      <section className="py-20 relative z-10 overflow-hidden">
        <h4 className={SectionTitle}>اعتماد، بزرگ‌ترین سرمایه ما</h4>

        <p className="text-center text-neutral-600 leading-9 w-10/12 md:w-8/12 mx-auto mt-6">
          ...
          همکاری است. امروز، افتخار می‌کنیم که بخشی از مسیر رشد کسب‌وکارهای
          مختلف بوده‌ایم و همچنان با انگیزه و مسئولیت‌پذیری، در کنار مشتریان خود
          برای خلق راهکارهای نوآورانه و ماندگار قدم برمی‌داریم.
        </p>

        <div className="relative w-11/12 md:w-8/12 h-[35rem] mx-auto mt-20">
          {/* پس‌زمینه */}
          <div className="absolute inset-0 rounded-[3rem] bg-gradient-to-br from-primary to-accent shadow-2xl" />

          <div className="absolute inset-0 rounded-[3rem] rotate-6 bg-primary/20 -z-10" />
      ...
      {/* SERVICES */}
      <section className="mt-30 relative z-10">
        <h4 className={SectionTitle}>خدماتی که ما ارائه می‌دهیم</h4>
      ...
      <section className="py-20 mt-20 relative overflow-hidden px-10">
        ...
        <div className="relative z-10">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className={`${SectionTitle} mt-4`}>چرا ما را انتخاب کنید؟</h2>
    ...
    "
        ...
        >
          ...
          >
            ...
            <img
              className="relative left-4 z-10 w-64 transition-all lg:w-72 group-hover:scale-110"
              src={project}
              alt="Project"
            />
          </div>
